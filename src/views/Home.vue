...
const openSource: P[] = [
	...
	{name: 'Momentum', icon: 'https://git.zakscode.com/ztimson/momentum/raw/branch/develop/src/public/favicon.svg', link: 'https://git.zakscode.com/ztimson/momentum', source: 'https://git.zakscode.com/ztimson/momentum', description: 'Server Development Platform'},
