...
const openSource: P[] = [
	...
	{name: 'Momentum', icon: 'https://git.zakscode.com/repo-avatars/27a82194c0ab58615e71069b69d117a65c26564e7fe9199df250a3971d3174a0', link: 'https://git.zakscode.com/ztimson/momentum', source: 'https://git.zakscode.com/ztimson/momentum', description: 'Server Development Platform'},
